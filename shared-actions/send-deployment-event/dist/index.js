...
const removeSlash = __webpack_require__(317)
const looselyValidate = __webpack_require__(854)
const axios = __webpack_require__(53)
const axiosRetry = __webpack_require__(346)
const ms = __webpack_require__(977)
const uuid = __webpack_require__(494)
const md5 = __webpack_require__(591)
const version = __webpack_require__(387).version
const isString = __webpack_require__(298)
...
module.exports = {"name":"analytics-node","version":"3.5.0","description":"The hassle-free way to integrate analytics into any Node.js application","license":"MIT","repository":"segmentio/analytics-node","author":{"name":"Segment","email":"tools+npm@segment.com","url":"https://segment.com"},"engines":{"node":">=4"},"size-limit":[{"limit":"25 KB","path":"index.js"}],"scripts":{"circle-lint":".buildscript/circle.sh","dependencies":"yarn","size":"size-limit","test":"standard && nyc ava --timeout=20s&& .buildscript/e2e.sh","report-coverage":"nyc report --reporter=lcov > coverage.lcov && codecov","np":"np --no-publish","release":"yarn run np"},"files":["index.js"],"keywords":["analytics","stats","segment.io","segmentio","segment","client","driver"],"dependencies":{"@segment/loosely-validate-event":"^2.0.0","axios":"^0.21.1","axios-retry":"^3.0.2","lodash.isstring":"^4.0.1","md5":"^2.2.1","ms":"^2.0.0","remove-trailing-slash":"^0.1.0","uuid":"^3.2.1"},"devDependencies":{"ava":"^0.25.0","basic-auth":"^2.0.1","body-parser":"^1.17.1","codecov":"^3.0.0","commander":"^2.9.0","delay":"^4.2.0","express":"^4.15.2","husky":"^3.0.4","nyc":"^14.1.1","pify":"^4.0.1","sinon":"^7.3.2","size-limit":"^1.3.5","snyk":"^1.171.1","standard":"^12.0.1"}};
...
var join = __webpack_require__(393)
var assert = __webpack_require__(357)
...
const Analytics = __webpack_require__(39)
